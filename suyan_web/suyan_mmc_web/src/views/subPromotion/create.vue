<template>
  <Form style="margin-top: 10px;" ref="createSubPromotionForm" :rules="ruleValidate" :model="formSubPromotion"
        :label-width="150">
    ...
    <FormItem>
      ...
      <Button @click="$router.push({name: 'subPromotionIndex'});" style="margin-left: 15px;">返回订单促销列表</Button>
    </FormItem>
  </Form>
</template>
<script>
            ...
            this.$http({
              ...
              if (data && data.code === 200) {
                this.$Message.success({
                  ...
                  duration: 2,
                  onClose: function () {
                    t.$router.push({name: 'subPromotionIndex'});
                  }
                });
              } else {
                if (promotionStatus == 1) {
