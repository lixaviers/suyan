  ...
  <div>
    <Form :model="dataForm" inline>
      ...
      <FormItem>
        ...
        <Button type="primary" @click="$router.push({name: 'subPromotionCreate'});" style="margin-left: 10px;">创建订单促销</Button>
      </FormItem>
    </Form>
          ...
          },
          {
            ...
            render: (h, params) => {
              ...
              var actionButtons = [h('Button', {
                ...
                on: {
                  click: () => {
                    this.$router.push({name: 'subPromotionShow', params: {id: params.row.id}});
                  }
                }
              }, '查看')];
              if (params.row.promotionStatus == 1) {
                actionButtons.push(h('Button', {
                  ...
                  on: {
                    click: () => {
                      this.$router.push({name: 'subPromotionCreate', params: {id: params.row.id}});
                    }
                  }
                }, '编辑'));
                actionButtons.push(h('Button', {
