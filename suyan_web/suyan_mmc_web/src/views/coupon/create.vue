<template>
  <Form style="margin-top: 10px;" ref="createCouponForm" :rules="ruleValidate" :model="formCoupon" :label-width="150">
    ...
    <FormItem>
      ...
      <Button @click="$router.push({name: 'couponIndex'});" style="margin-left: 15px;">返回优惠券列表</Button>
    </FormItem>
  </Form>
</template>
<script>
            ...
            this.$http({
              ...
              if (data && data.code === 200) {
                this.$Message.success({
                  ...
                  duration: 2,
                  onClose: function () {
                    t.$router.push({name: 'couponIndex'});
                  }
                });
              } else {
                if (couponStatus == 1) {
