  ...
  <div>
    <Form :model="dataForm" inline>
      ...
      <FormItem>
        ...
        <Button type="primary" @click="$router.push({name: 'couponCreate'});" style="margin-left: 10px;">创建优惠券</Button>
      </FormItem>
    </Form>
          ...
          },
          {
            ...
            render: (h, params) => {
              ...
              var actionButtons = [h('Button', {
                ...
                on: {
                  click: () => {
                    this.$router.push({name: 'couponShow', params: {id: params.row.id}});
                  }
                }
              }, '查看')];
              if (params.row.couponStatus == 1) {
                actionButtons.push(h('Button', {
                  ...
                  on: {
                    click: () => {
                      this.$router.push({name: 'couponCreate', params: {id: params.row.id}});
                    }
                  }
                }, '编辑'));
                actionButtons.push(h('Button', {
