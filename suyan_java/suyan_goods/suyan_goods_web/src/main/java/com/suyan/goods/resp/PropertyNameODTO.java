...
public class PropertyNameODTO implements Serializable {
    ...
    private List<PropertyValuesODTO> propertyValuesList;

    public List<PropertyValuesODTO> getPropertyValuesList() {
        return propertyValuesList;
    }

    public void setPropertyValuesList(List<PropertyValuesODTO> propertyValuesList) {
