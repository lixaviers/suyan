package com.suyan.user.interceptor;
...
public class ServiceInterceptor {
    ...
    @Around("execution(* com.suyan.user.service..*.*(..))")
    public Object intercept(ProceedingJoinPoint pjp) throws Throwable {
        ...
        try {
            ...
            UserResult<Object> r = UserResult.newSuccess();
            r.setErrorCode(e.getUserResultCode());
            ...
            UserResult<Object> r = UserResult.newSuccess();
            r.setErrorCode(UserResultCode.SYS_ERROR);
            ret = r;
        }
