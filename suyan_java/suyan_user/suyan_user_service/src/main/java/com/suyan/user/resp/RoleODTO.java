...
@ApiModel("角色")
public class RoleODTO implements Serializable {
    ...
    public String getRoleStatusDesc() {
        return roleStatusDesc;
    }

    public void setRoleStatusDesc(String roleStatusDesc) {
        this.roleStatusDesc = roleStatusDesc;
    }
